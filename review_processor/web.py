...
<table class="mat" border="1" cellspacing="0" cellpadding="0" width="100%">
  <colgroup><col width="5%"><col width="75%"><col width="10%"><col width="10%"></colgroup>
  <tr>
    <th>№ по порядку</th>
