...
class ComputePalletSummaryTests(unittest.TestCase):
    ...
    def test_example_one_full_pallet(self, _ensure):
        # 100 pcs, box_qty=10, boxes_per_pallet=10 → 1.0 pallet
        repo = MagicMock()
        ...
        self.assertEqual(summary[0]["pallets_label"], "1 паллета")
    ...
    def test_fractional_rounding_to_hundredths(self, _ensure):
        ...
        self.assertEqual(summary[0]["pallets_label"], "0,25 паллета")
