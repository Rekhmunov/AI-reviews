...
def test_ttn_list_clusters_by_group_id() -> None:
    """Grouped TN rows stay adjacent: highest doc_number first, within group by id ASC."""
    from review_processor.repository import cluster_supply_ttn_records_by_group

    rows = [
        {"id": 1, "group_id": "", "doc_number": "1", "created_at": "2026-09-01T10:00:00"},
        {"id": 3, "group_id": "g1", "doc_number": "3", "created_at": "2026-09-02T10:01:00"},
        {"id": 2, "group_id": "g1", "doc_number": "2", "created_at": "2026-09-02T10:00:00"},
        {"id": 4, "group_id": "", "doc_number": "4", "created_at": "2026-09-03T10:00:00"},
        {"id": 6, "group_id": "g2", "doc_number": "6", "created_at": "2026-09-04T10:00:00"},
        {"id": 5, "group_id": "g2", "doc_number": "5", "created_at": "2026-09-02T12:00:00"},
    ]
...
def test_ttn_list_clusters_prefers_doc_number_over_created_at() -> None:
    from review_processor.repository import cluster_supply_ttn_records_by_group

    rows = [
        {"id": 10, "group_id": "", "doc_number": "2", "created_at": "2026-09-10T10:00:00"},
        {"id": 11, "group_id": "", "doc_number": "9", "created_at": "2026-09-01T10:00:00"},
        {"id": 12, "group_id": "g", "doc_number": "3", "created_at": "2026-09-11T10:00:00"},
        {"id": 13, "group_id": "g", "doc_number": "4", "created_at": "2026-09-01T10:00:00"},
    ]
    out = cluster_supply_ttn_records_by_group(rows)
